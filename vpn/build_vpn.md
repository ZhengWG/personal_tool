...
-   ssh root@服务器ip 登录服务器
    ...
    -   Chrome安装插件:Proxy SwitchOmega
        -   配置代理协议(SOCKS5)&&代理服务器( `127.0.0.1` )&&代理端口( `1086` ) ![img](../img/build_vpn_20210724_195925.png)
    ...
    -   ios配置: 参考：[blog](http://www.alanwei.com/blog/2021/03/06/ipsec-clients-l2tp/#ios)
        ...
        iphone通过 `L2TP` 连接： 通用->添加VPN配置->选择L2TP->输入用户名/密码/IPsec密码->完成->连接 电脑也可以通过添加L2TP VPN连接： ![img](../img/build_vpn_20210724_195805.png)
